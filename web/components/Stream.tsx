        ...
        <div id={`${styles.stream__container}`}>
            <div id={`${styles.stream__box}`}>
                <div id={`${styles.video__container}`}>
                    {focussedOn === -1 ? (
                       <PeerVideo muted stream={userStream.current} style={"noStyle"}/>
            ...
            <div className={`${styles.stream__actions}`}>
                <button id={styles.onlySM} onClick={showMembersHandler}>
                ...
                <button id={`${styles.onlySM}`} onClick={showChatHandler}>
